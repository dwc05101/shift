...
// ====================================================
// GraphQL mutation operation: ConfirmTimeTable
// ====================================================

export interface ConfirmTimeTable_ConfirmTimeTable {
  __typename: "ConfirmTimeTableResponse"
  ok: boolean
  error: string | null
}

export interface ConfirmTimeTable {
  ConfirmTimeTable: ConfirmTimeTable_ConfirmTimeTable
}

export interface ConfirmTimeTableVariables {
  timetableId: number
}
